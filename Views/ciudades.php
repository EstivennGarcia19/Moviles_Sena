	...
	<main>
		<div id="p-section">
			...
			<div class="container">
				...
				<form action="../Controller/registerNewCity.php" method="POST" class="formulario">

					<h1>Registrar Ciudad</h1>

					<p>Registra una ciudad en la base de datos</p>					

					<div class="cont-form">
						<input type="number" name="cod_ciudad" required="true" placeholder="Codigo">												
					</div>	
					<div class="cont-form">
						<input type="text" name="ciudad" required="true" placeholder="Nombre">												
					</div>	
					...
					<div class="cont-form">
						...
						<p>¿Quieres ver mas? <a href="showCities.php">Clic</a > aqui</p> <br>
